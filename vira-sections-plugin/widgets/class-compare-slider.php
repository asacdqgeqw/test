...
class Vira_Sections_Widget_Compare_Slider extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		<style>
			...
			#<?php echo esc_attr( $unique_id ); ?> .vira-cmp h2, #<?php echo esc_attr( $unique_id ); ?> .vira-cmp__title{font-size:clamp(28px,3.4vw,46px);font-weight:800;margin:0 0 16px;line-height:1.4;color:var(--vira-head);}
			#<?php echo esc_attr( $unique_id ); ?> .vira-cmp h2 em, #<?php echo esc_attr( $unique_id ); ?> .vira-cmp__title em{
				font-style:normal;
				...
				<?php if ( $show_head ) : ?>
					<div class="vira-cmp__head">
						...
						<?php if ( ! empty( $settings['heading'] ) ) : ?>
							...
							<<?php echo $heading_tag; ?> class="vira-cmp__title"><?php echo wp_kses_post( $settings['heading'] ); ?></<?php echo $heading_tag; ?>>
						<?php endif; ?>
