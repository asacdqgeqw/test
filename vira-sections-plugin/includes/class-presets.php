	...
	private static function get_vira_hero_presets() {
		return array(
			'website-design' => array_merge( self::$palettes['website-design'], array(
				...
				'marquee_items'      => array(
					array( 'text' => 'وردپرس + المنتور' ),
					array( 'text' => 'طراحی ریسپانسیو' ),
					array( 'text' => 'سئو فنی' ),
					array( 'text' => 'سرعت بالا' ),
					array( 'text' => 'UI/UX اختصاصی' ),
			...
			'seo-google' => array_merge( self::$palettes['seo-google'], array(
				...
				'stats'              => array(
					array( 'stat_value' => '۲۸۰', 'stat_suffix' => '٪+', 'stat_label' => 'میانگین رشد ترافیک' ),
					array( 'stat_value' => '۱۲۵', 'stat_suffix' => '+', 'stat_label' => 'سایت در صفحه اول' ),
					array( 'stat_value' => '۳', 'stat_suffix' => ' ماهه', 'stat_label' => 'شروع نتایج پایدار' ),
				),
				'marquee_items'      => array(
					array( 'text' => 'سئو فنی' ),
					array( 'text' => 'لینک‌سازی' ),
					array( 'text' => 'تحقیق کلمات کلیدی' ),
					array( 'text' => 'محتوای هدفمند' ),
					array( 'text' => 'سئو محلی' ),
					array( 'text' => 'آنالیز رقبا' ),
					array( 'text' => 'Core Web Vitals' ),
				),
			) ),
			'seo-training-tabriz' => array_merge( self::$palettes['seo-training-tabriz'], array(
				...
				'stats'              => array(
					array( 'stat_value' => '۸۰۰', 'stat_suffix' => '+', 'stat_label' => 'شاگرد آموزش‌دیده' ),
					array( 'stat_value' => '۹۲', 'stat_suffix' => '٪', 'stat_label' => 'رضایت شاگردان' ),
					array( 'stat_value' => '۱۰', 'stat_suffix' => '+', 'stat_label' => 'سال تدریس' ),
				),
				'marquee_items'      => array(
					array( 'text' => 'آموزش خصوصی' ),
					array( 'text' => 'دوره گروهی' ),
					array( 'text' => 'آموزش سازمانی' ),
					array( 'text' => 'مشاوره ساعتی' ),
					array( 'text' => 'آنالیز سایت' ),
					array( 'text' => 'گواهی معتبر' ),
					array( 'text' => 'پروژه واقعی' ),
				),
			) ),
			'app-android-tabriz' => array_merge( self::$palettes['app-android-tabriz'], array(
				...
				'btn_secondary_text' => 'مشاهده پکیج‌ها',
				'stats'              => array(
					array( 'stat_value' => '۱۲۰', 'stat_suffix' => '+', 'stat_label' => 'اپلیکیشن منتشرشده' ),
					array( 'stat_value' => '۲', 'stat_suffix' => 'M+', 'stat_label' => 'دانلود فعال' ),
					array( 'stat_value' => '۴.۷', 'stat_suffix' => '★', 'stat_label' => 'میانگین امتیاز' ),
				),
				'marquee_items'      => array(
					array( 'text' => 'Native Android' ),
					array( 'text' => 'Flutter' ),
					array( 'text' => 'React Native' ),
					array( 'text' => 'Kotlin' ),
					array( 'text' => 'Firebase' ),
					array( 'text' => 'درگاه پرداخت' ),
		...
		return array(
			'website-design' => array_merge( self::$palettes['website-design'], array(
				...
				'select_options'  => array(
					array( 'option_text' => 'سایت شرکتی / معرفی خدمات' ),
					array( 'option_text' => 'فروشگاه اینترنتی' ),
					array( 'option_text' => 'سایت خبری / محتوایی' ),
					array( 'option_text' => 'پلتفرم اختصاصی' ),
			...
			'seo-google' => array_merge( self::$palettes['seo-google'], array(
				...
				'features'        => array(
					array( 'feature_text' => 'آنالیز رایگان سایت و رقبا' ),
					array( 'feature_text' => 'گزارش کامل رقبای شما' ),
					array( 'feature_text' => 'بدون تعهد و کاملاً رایگان' ),
					array( 'feature_text' => 'پاسخ‌گویی در کمتر از ۲ ساعت' ),
				),
				'select_options'  => array(
					array( 'option_text' => 'تا ۵ میلیون تومان' ),
					array( 'option_text' => '۵ تا ۱۰ میلیون تومان' ),
					array( 'option_text' => 'بیش از ۱۰ میلیون تومان' ),
					array( 'option_text' => 'نیاز به مشاوره دارم' ),
				),
			...
			'seo-training-tabriz' => array_merge( self::$palettes['seo-training-tabriz'], array(
				...
				'features'        => array(
					array( 'feature_text' => 'مشاوره رایگان انتخاب دوره' ),
					array( 'feature_text' => 'بدون تعهد ثبت‌نام' ),
					array( 'feature_text' => 'پاسخ در کمتر از ۲ ساعت' ),
				),
				'select_options'  => array(
					array( 'option_text' => 'آموزش خصوصی' ),
					array( 'option_text' => 'دوره گروهی' ),
					array( 'option_text' => 'آموزش سازمانی' ),
					array( 'option_text' => 'مشاوره ساعتی' ),
					array( 'option_text' => 'آنالیز سایت' ),
				),
				'submit_text'     => 'ارسال درخواست',
			) ),
			'app-android-tabriz' => array_merge( self::$palettes['app-android-tabriz'], array(
				...
				'features'        => array(
					array( 'feature_text' => 'مشاوره فنی رایگان' ),
					array( 'feature_text' => 'تخمین زمان و هزینه' ),
					array( 'feature_text' => 'بدون تعهد اولیه' ),
				),
				'select_options'  => array(
					array( 'option_text' => 'اپ فروشگاهی' ),
					array( 'option_text' => 'اپ خدماتی' ),
					array( 'option_text' => 'شبکه اجتماعی' ),
					array( 'option_text' => 'اپ سازمانی' ),
					array( 'option_text' => 'سایر' ),
				),
	...
	private static function get_vira_process_timeline_presets() {
		return array(
			'website-design' => array(
				...
				'steps'       => array(
					array( 'step_number' => '۱', 'step_title' => 'کشف', 'step_duration' => '۲ روز', 'panel_title' => 'کشف و استراتژی', 'panel_description' => 'جلسه تحلیل کسب‌وکار، رقبا و مخاطب هدف. در این مرحله نقشه راه پروژه تدوین و KPI‌های موفقیت تعیین می‌شوند.', 'panel_deliverables' => "جلسه ۹۰ دقیقه‌ای کشف نیازمندی‌ها\nتحلیل ۵ رقیب اصلی شما\nتعریف Persona و User Journey\nتدوین سند RFP و نقشه راه" ),
					array( 'step_number' => '۲', 'step_title' => 'طراحی', 'step_duration' => '۷ روز', 'panel_title' => 'طراحی UI/UX اختصاصی', 'panel_description' => 'ابتدا وایرفریم برای تأیید ساختار، سپس طراحی نهایی در فیگما با امکان مشاهده زنده و کامنت‌گذاری شما.', 'panel_deliverables' => "وایرفریم تعاملی در Figma\nطراحی نهایی موبایل + دسکتاپ\nسیستم طراحی (Design System)\n۳ نوبت بازنگری رایگان" ),
					array( 'step_number' => '۳', 'step_title' => 'توسعه', 'step_duration' => '۱۴ روز', 'panel_title' => 'توسعه و پیاده‌سازی', 'panel_description' => 'کدنویسی استاندارد روی وردپرس + المنتور یا Headless. Code review مرحله‌ای + تست کیفی توسط تیم QA.', 'panel_deliverables' => "کدنویسی Clean و Semantic\nتست Cross-Browser + موبایل\nبهینه‌سازی سرعت (PageSpeed 90+)\nآموزش استفاده از پنل" ),
					array( 'step_number' => '۴', 'step_title' => 'انتشار', 'step_duration' => '۲ روز', 'panel_title' => 'انتشار و پشتیبانی', 'panel_description' => 'انتشار نهایی با SSL، CDN و مانیتورینگ. شروع دوره پشتیبانی رایگان و آموزش تیم شما.', 'panel_deliverables' => "راه‌اندازی SSL و CDN\nتنظیم Google Analytics + Search Console\nشروع پشتیبانی ۳-۶ ماهه\nگزارش هفتگی عملکرد" ),
				),
			),
			'seo-google' => array(
				'eyebrow'     => 'فرآیند سئو',
				...
				'steps'       => array(
					array( 'step_number' => '۱', 'step_title' => 'آنالیز', 'step_duration' => '۱ هفته', 'panel_title' => 'آدیت و آنالیز', 'panel_description' => 'بررسی کامل وضعیت فنی سایت، تحلیل رقبا و تحقیق کلمات کلیدی.', 'panel_deliverables' => "آدیت فنی ۲۰۰+ فاکتور\nتحقیق کلمات کلیدی\nتحلیل ۵ رقیب اصلی\nتدوین استراتژی ۶ ماهه" ),
					array( 'step_number' => '۲', 'step_title' => 'بهینه‌سازی', 'step_duration' => '۲ هفته', 'panel_title' => 'سئو فنی و On-Page', 'panel_description' => 'رفع مشکلات فنی، بهینه‌سازی محتوا و ساختار سایت.', 'panel_deliverables' => "رفع خطاهای Crawl\nبهینه‌سازی Core Web Vitals\nSchema Markup\nبهینه‌سازی محتوای موجود" ),
					array( 'step_number' => '۳', 'step_title' => 'محتوا', 'step_duration' => 'مستمر', 'panel_title' => 'تولید محتوا و لینک‌سازی', 'panel_description' => 'تولید محتوای هدفمند و لینک‌سازی White-Hat برای افزایش اتوریتی.', 'panel_deliverables' => "تولید محتوای SEO-Friendly\nلینک‌سازی Guest Post\nDigital PR\nبهینه‌سازی مداوم" ),
					array( 'step_number' => '۴', 'step_title' => 'رشد', 'step_duration' => 'مستمر', 'panel_title' => 'مانیتورینگ و رشد', 'panel_description' => 'پایش روزانه رتبه‌ها، گزارش‌دهی و بهینه‌سازی مستمر برای حفظ و ارتقای نتایج.', 'panel_deliverables' => "داشبورد زنده رتبه‌ها\nگزارش هفتگی/ماهانه\nآنالیز رقبا مستمر\nبهینه‌سازی نرخ تبدیل" ),
				),
			),
			'app-android-tabriz' => array(
				...
				'steps'       => array(
					array( 'step_number' => '۱', 'step_title' => 'نیازسنجی', 'step_duration' => '۱ هفته', 'panel_title' => 'تحلیل و نیازسنجی', 'panel_description' => 'بررسی ایده، تحلیل بازار و رقبا، تعریف MVP و نقشه راه توسعه.', 'panel_deliverables' => "جلسه نیازسنجی\nتحلیل رقبا\nتعریف MVP\nRoadmap توسعه" ),
	...
	private static function get_vira_tech_stack_presets() {
		return array(
			'app-android-tabriz' => array(
				...
				'tabs'        => array(
					array( 'tab_title' => 'Frontend', 'tab_items' => "Kotlin\nFlutter\nReact Native\nJetpack Compose" ),
					array( 'tab_title' => 'Backend', 'tab_items' => "Node.js\nLaravel\nFirebase\nSupabase" ),
					array( 'tab_title' => 'DevOps', 'tab_items' => "Docker\nGitHub Actions\nCI/CD\nAWS" ),
					array( 'tab_title' => 'ابزارها', 'tab_items' => "Figma\nJira\nPostman\nSentry" ),
				),
				'logos'       => array(
	...
	private static function get_vira_stats_counter_presets() {
		return array(
			'seo-google' => array(
				...
				'counters'    => array(
					array( 'counter_value' => '۳۴۰', 'counter_suffix' => '٪', 'counter_label' => 'میانگین رشد ترافیک' ),
					array( 'counter_value' => '۱۲۵', 'counter_suffix' => '+', 'counter_label' => 'سایت در صفحه اول' ),
					array( 'counter_value' => '۹۵', 'counter_suffix' => '٪', 'counter_label' => 'رضایت مشتریان' ),
					array( 'counter_value' => '۵۸', 'counter_suffix' => '+', 'counter_label' => 'کلمه کلیدی رتبه ۱' ),
				),
	...
	private static function get_vira_curriculum_presets() {
		return array(
			'seo-training-tabriz' => array(
				...
				'totals_hours'  => '۴۰+',
				'modules'       => array(
					array( 'module_number' => '۱', 'module_title' => 'مبانی سئو و موتورهای جستجو', 'module_subtitle' => 'شناخت پایه‌ای دنیای سئو', 'chips' => '۴ جلسه | ۶ ساعت | مقدماتی', 'topics' => "مفاهیم پایه و تاریخچه سئو\nنحوه کار موتورهای جستجو (Crawl, Index, Rank)\nالگوریتم‌های مهم گوگل (Panda, Penguin, BERT, Helpful Content)\nE-E-A-T و فاکتورهای کیفیت محتوا\nتفاوت White-Hat و Black-Hat SEO\nنقشه راه شخصی برای ورود به سئو" ),
					array( 'module_number' => '۲', 'module_title' => 'تحقیق کلمات کلیدی حرفه‌ای', 'module_subtitle' => 'پیدا کردن کلمات طلایی برای رتبه گرفتن', 'chips' => '۵ جلسه | ۷ ساعت | متوسط', 'topics' => "مفاهیم Search Volume، KD و Search Intent\nکار با Ahrefs و Semrush در تحقیق کلمات\nکلمات Long-tail و Question-based\nTopic Cluster و Keyword Mapping\nتحلیل کلمات کلیدی رقبا\nپروژه عملی: ساخت Keyword Plan کامل" ),
					array( 'module_number' => '۳', 'module_title' => 'سئو فنی و Core Web Vitals', 'module_subtitle' => 'زیرساخت قدرتمند برای رتبه‌گیری', 'chips' => '۶ جلسه | ۸ ساعت | پیشرفته', 'topics' => "Crawlability و Indexability سایت\nCore Web Vitals (LCP, INP, CLS)\nSchema Markup و Structured Data\nrobots.txt، sitemap.xml و canonical\nHTTPS، Mobile-First و JavaScript SEO\nپروژه عملی: آدیت فنی یک سایت واقعی" ),
					array( 'module_number' => '۴', 'module_title' => 'سئو محتوا و Content Strategy', 'module_subtitle' => 'محتوایی که گوگل و کاربر هر دو دوست دارند', 'chips' => '۵ جلسه | ۷ ساعت | متوسط', 'topics' => "اصول نوشتن محتوای SEO-Friendly\nساختار هدینگ‌ها و Featured Snippets\nContent Gap Analysis\nتقویم محتوایی\nبهینه‌سازی محتوای موجود\nپروژه عملی: نوشتن محتوای رتبه‌ساز" ),
					array( 'module_number' => '۵', 'module_title' => 'لینک‌سازی حرفه‌ای', 'module_subtitle' => 'ساخت اتوریتی با روش‌های امن', 'chips' => '۴ جلسه | ۶ ساعت | پیشرفته', 'topics' => "اصول لینک‌سازی White-Hat\nGuest Posting حرفه‌ای\nDigital PR و HARO\nBroken Link Building\nتحلیل بک‌لینک رقبا\nپروژه عملی: ساخت ۵ بک‌لینک واقعی" ),
					array( 'module_number' => '۶', 'module_title' => 'سئو محلی (Local SEO)', 'module_subtitle' => 'تسلط بر Google Map و نتایج محلی', 'chips' => '۳ جلسه | ۴ ساعت | متوسط', 'topics' => "Google Business Profile\nNAP Consistency\nReview Management\nLocal Citations\nMap Pack Ranking\nپروژه عملی: بهینه‌سازی GBP" ),
					array( 'module_number' => '۷', 'module_title' => 'ابزارهای سئو', 'module_subtitle' => 'تسلط بر ابزارهای حرفه‌ای', 'chips' => '۴ جلسه | ۵ ساعت | متوسط', 'topics' => "Google Search Console\nGoogle Analytics 4\nAhrefs و Semrush\nScreaming Frog\nSurfer SEO و Clearscope\nپروژه عملی: ساخت داشبورد سئو" ),
					array( 'module_number' => '۸', 'module_title' => 'پروژه پایانی و کسب درآمد', 'module_subtitle' => 'شروع کار حرفه‌ای در دنیای سئو', 'chips' => '۳ جلسه | ۵ ساعت | پیشرفته', 'topics' => "ساخت رزومه و پورتفولیو\nقیمت‌گذاری خدمات سئو\nجذب مشتری اول\nفریلنسری vs استخدام\nارائه پروژه پایانی\nدریافت گواهی پایان دوره" ),
				),
			),
		);
	}
